...
const LoginPage = () => {
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div
        data-section="left"
        className={`relative w-1/2 h-full bg-black flex flex-col justify-start pt-32 -ml-36 z-10 transition-all duration-1000 ${
      ...
      >
        <h1 className="text-[#D8AF7F] text-[70px] font-bold mb-4 leading-tight">
          Power Allure
        </h1>
        <p className="text-[#D8AF7F] text-2xl">
      ...
      <div className="absolute inset-0 flex justify-end items-center bg-[#D8AF7F] z-0">
        ...
        >
          <h2 className="text-black text-5xl font-bold mb-8">Login</h2>
          <div className="w-96 flex flex-col gap-4">
            <input
              ...
              className="w-full p-5 rounded-xl bg-[#c5c4c4] placeholder-gray-600 text-black text-lg focus:outline-none"
            />
            <input
              type="password"
          ...
          <button
            onClick={handleLogin}
            disabled={isLoading}
            className={`mt-8 px-12 py-4 text-xl rounded-full bg-[#c5c4c4] text-black font-semibold transition-colors ${
